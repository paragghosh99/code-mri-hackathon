...
export default function ChatPage() {
  ...
  async function handleSubmit() {
    ...
    // deleted command dependency ---------------------------------------------------------> FIXED
    ...
    try {
      ...
      const response =await fetch("https://code-mri-service-94165953450.us-central1.run.app/command", {
        method: "POST",
        headers: {
  ...
  return (
    ...
    <div className="landing-subtitle">
      ...
      <div className="view-button-placeholder">
